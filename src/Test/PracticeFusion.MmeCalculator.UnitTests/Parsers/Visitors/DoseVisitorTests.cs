...
namespace PracticeFusion.MmeCalculator.UnitTests.Parsers.Visitors
{
    ...
    public class DoseVisitorTests
    {
        ...
        private static IEnumerable<object[]> TestData =>
            new List<object[]>
            {
                new object[] { "1 mg", "1 mg" },
                new object[] { "1 - 2 mg", "1-2 mg" },
                new object[] { "1 - 2 mg (1 - 2 ml)", "1-2 mg (1-2 ml)" },
                new object[] { "1 mg - 2 mg (1 ml - 2 ml)", "1-2 mg (1-2 ml)" },
                new object[] { "1 mg (1 ml)", "1 mg (1 ml)" },
        ...
        {
            DefaultParser.DoseContext tree = _helper.DefaultParser(statement).dose();
            Dose result = _helper.Visitor.VisitRoot(tree);

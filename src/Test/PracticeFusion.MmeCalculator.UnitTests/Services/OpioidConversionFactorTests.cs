    ...
    public class OpioidConversionFactorTests
    {
        ...
        private static IEnumerable<object[]> TestData =>
            new List<object[]>
            {
                new object[]
                {
                    OpioidEnum.Buprenorphine, 1m, UnitOfMeasureEnum.Milligram, new[] { FormEnum.Tablet }, 0m
                },
                new object[] { OpioidEnum.Buprenorphine, 1m, UnitOfMeasureEnum.Milligram, new[] { FormEnum.Film }, 0m },
                new object[]
                {
                    OpioidEnum.Buprenorphine, 1m, UnitOfMeasureEnum.MicrogramPerHour, new[] { FormEnum.Patch }, 0m
                },
                new object[]
                {
                    OpioidEnum.Buprenorphine, 1m, UnitOfMeasureEnum.MicrogramPerHour,
                    new[] { FormEnum.Transdermal }, 0m
                },
                ...
                new object[]
                {
                    OpioidEnum.Dihydrocodeine, 1m, UnitOfMeasureEnum.Milligram, new[] { FormEnum.Dose }, 0.25m
                },
                new object[]
                {
                    OpioidEnum.Fentanyl, 100m, UnitOfMeasureEnum.Microgram,
                    new[] { FormEnum.Buccal, FormEnum.Tablet }, 0.13m
                },
                new object[]
                {
                    OpioidEnum.Fentanyl, 100m, UnitOfMeasureEnum.Microgram,
                    new[] { FormEnum.Sublingual, FormEnum.Tablet }, 0.13m
                },
                new object[]
                {
                    OpioidEnum.Fentanyl, 100m, UnitOfMeasureEnum.Microgram, new[] { FormEnum.Lozenge }, 0.13m
                },
                new object[] { OpioidEnum.Fentanyl, 100m, UnitOfMeasureEnum.Microgram, new[] { FormEnum.Film }, 0.18m },
                new object[]
                {
                    OpioidEnum.Fentanyl, 100m, UnitOfMeasureEnum.Microgram, new[] { FormEnum.Oral, FormEnum.Spray },
                    0.18m
                },
                new object[]
                {
                    OpioidEnum.Fentanyl, 100m, UnitOfMeasureEnum.Microgram,
                    new[] { FormEnum.Nasal, FormEnum.Spray }, 0.16m
                },
                ...
                new object[]
                {
                    OpioidEnum.Pentazocine, 1m, UnitOfMeasureEnum.Milligram, new[] { FormEnum.Dose }, 0.37m
                },
                ...
                new object[]
                {
                    OpioidEnum.Tramadol, 1m * 1000, UnitOfMeasureEnum.Microgram, new[] { FormEnum.Dose },
                    0.1m / 1000
                },
                new object[]
                {
                    OpioidEnum.Hydrocodone, 1m * 1000, UnitOfMeasureEnum.Microgram, new[] { FormEnum.Dose },
                    1m / 1000
                },
                new object[]
                {
                    OpioidEnum.Methadone, 61m * 1000, UnitOfMeasureEnum.Microgram, new[] { FormEnum.Dose },
                    12m / 1000
                },
                ...
                new object[]
                {
                    OpioidEnum.Fentanyl, 100m / 1000, UnitOfMeasureEnum.Milligram,
                    new[] { FormEnum.Nasal, FormEnum.Spray }, 0.16m * 1000
                }
            };
        ...
        {
            var factor = _conversionFactor.LookupConversionFactor(
                opioid,
                maxDailyDose,
                uom,
        ...
        public static string DisplayName(MethodInfo methodInfo, object[] data)
        {
            if (data != null)
            {
                var opioid = new Opioid { ValueEnum = (OpioidEnum)data[0] };

...
namespace PracticeFusion.MmeCalculator.UnitTests.Services.ParsingTests
{
    ...
    {
        private readonly ICalculator _calculator = new Calculator(new MedicationParser(new Client()));
        ...
        private static IEnumerable<object[]> TestData =>
            new List<object[]>
            {
                ...
                new object[]
                {
                    "897753", "infuse 1 ml 4 times daily", "1 ML Hydromorphone Hydrochloride 4 MG/ML Injection",
                    64m
                },
                new object[]
                {
                    "262071",
                    "Apply two patches to upper torso q48h for chronic pain, exemption code B, palliative care",
                ...
                new object[]
                {
                    "897653", "1-2 ML EVERY 4 HOURS AS NEEDED",
                    "1 ML Hydromorphone Hydrochloride 1 MG/ML Injection", 48m
                },
                new object[]
                {
                ...
                new object[]
                {
                    "864769", "2-4 ml orally every 4 hours x 30 days",
                    "Methadone Hydrochloride 2 MG/ML Oral Solution", 480m
                },
                new object[] { "261106", "1 dose orally every day", "Fentanyl 0.2 MG Oral Lozenge [Actiq]", 26m },
                new object[]
                {
                    "261106", "Take 1 dose sublingually q 6 hr prn breakthrough pain",
                    "Fentanyl 0.2 MG Oral Lozenge [Actiq]", 104m
                },
                new object[]
                {
                ...
                new object[]
                {
                    "835603", "1-2 tab(s) orally 3 times daily as needed for pain.",
                    "tramadol hydrochloride 50 MG Oral Tablet", 30m
                },
                new object[]
                {
                    "864769", "1 ml every 6 hours", "Methadone Hydrochloride 2 MG/ML Oral Solution", 32m
                },
                new object[]
                {
                    "864769", "1.5 ml every 6 hours", "Methadone Hydrochloride 2 MG/ML Oral Solution", 48m
                },
                new object[]
                {
                ...
                {
                    "892625",
                    "0.5 milliliter(s) to 1 mL daily orally 4 times a day, as needed for breakthrough pain",
                    "Morphine Sulfate 20 MG/ML Oral Solution", 80m
                }
            };
        ...
        private static IEnumerable<object[]> ExceptionTestData =>
            new List<object[]>
            {
                ...
                new object[]
                {
                    "262071",
                    "Apply two patches to upper torso q48h for chronic pain - exemption code B, palliative care",
                    ConfidenceEnum.None, "Failed to parse the sig"
                }
            };

...
namespace PracticeFusion.MmeCalculator.Core.Parsers
{
    ...
    internal class ConfidenceErrorListener : BaseErrorListener
    {
        ...
        {
            _reporting.Add((ConfidenceEnum.None, $"Syntax error: unexpected '{offendingSymbol.Text}' at Ln {line}, Col {charPositionInLine}"));
        }
        ...
        {
            _reporting.Add((ConfidenceEnum.None, $"Ambiguous expression: '{recognizer.TokenStream.GetText(new Interval(startIndex, stopIndex))}'"));
        }
    }
}

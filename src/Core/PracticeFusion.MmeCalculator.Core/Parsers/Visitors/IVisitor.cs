...
namespace PracticeFusion.MmeCalculator.Core.Parsers.Visitors
{
    ...
    internal interface IVisitorCreator<TParserRuleContext, TOutput> : IVisitor<TParserRuleContext, TOutput>
        where TParserRuleContext : ParserRuleContext
    {
        TOutput VisitRoot(TParserRuleContext context);
    }

    internal interface IVisitorUpdator<TParserRuleContext, TOutput> : IVisitor<TParserRuleContext, TOutput>
        where TParserRuleContext : ParserRuleContext
    {

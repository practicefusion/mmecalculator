...
namespace PracticeFusion.MmeCalculator.Core.Messages
{
    ...
    public class OpioidAnalysis
    {
        ...
        /// <summary>
        ///     The maximum MME per day for <see cref="Opioid" />, calculated as <see cref="TotalDailyDose" /> x
        ///     <see cref="ConversionFactor" />.
        /// </summary>
        public decimal MaximumMmePerDay { get; set; }

        /// <summary>
        ///     A reference to every <see cref="CalculationItem" /> (the <see cref="CalculationItem.RequestItemId" />) used in this
        ///     analysis.
        /// </summary>
